...
export const en: Record<string, string> = {
        ...
        'settings.analyticsHeartbeat': 'Help improve Mindwtr',
        'settings.analyticsHeartbeatDesc': 'Sends anonymous diagnostics to help improve Mindwtr. No task text, notes, or personal data.',
        'settings.analyticsHeartbeatDisableTitle': 'Turn off diagnostics?',
        'settings.analyticsHeartbeatDisableDesc': 'Diagnostics never include task text, notes, user data, or personal info. They help improve Mindwtr without exposing your task data.',
        'settings.analyticsHeartbeatDisableConfirm': 'Turn off',
