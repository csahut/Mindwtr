...
export const deOverrides: Record<string, string> = {
        ...
        'settings.analyticsHeartbeat': 'Mindwtr verbessern helfen',
        'settings.analyticsHeartbeatDesc': 'Sendet anonyme Diagnosedaten, um Mindwtr zu verbessern. Keine Aufgabentexte, Notizen oder personenbezogenen Daten.',
        'settings.analyticsHeartbeatDisableTitle': 'Diagnostik ausschalten?',
        'settings.analyticsHeartbeatDisableDesc': 'Diagnosedaten enthalten nie Aufgabentexte, Notizen, Nutzerdaten oder persönliche Infos. Sie helfen, Mindwtr zu verbessern.',
        'settings.analyticsHeartbeatDisableConfirm': 'Ausschalten',
